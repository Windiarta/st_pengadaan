...
def get_data_index(data, datasimona, index, indexsimona):
    id_val, date_val, material_val, tender_val, item_val, ka_val, rkap_val, tpn_val, coa_val, discipline_val, eproc_val, dur_val, sap_val, user_val, vendor_val, status_val, deliv_val, penalty_val, oe_val, pook_val, realization_val, saving_val, other_val, other2_val, file_loc_val, forecast_val, cumulative_val, ir_val, a_val = set_default()
