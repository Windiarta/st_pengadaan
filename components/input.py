...
def get_inputs(data, nomor_po, index=0):
    #=============================================#
    #----------------- VAR INIT ------------------#
    #=============================================#
    if data is not None:
        ...
        item = ""
        ka_val = ka_option["M"][0]
        rkap_val = current_year
        tpn_val = tpn_option["M"][0]
        coa_val = coa_option["M"][0]
        discipline_val = discipline_option["M"][0]
